...
#
#        result_count = search_page.filter_results.results_count_int
#        Assert.true(result_count > 0)
#
#        filter_tag_area = search_page.filter_results.select_area('Tag')
#        tag_names = [tag.name for tag in filter_tag_area.tags]
#        Assert.contains('development', tag_names)
#
#        filter_tag_area.tag('development').click()
#
#        Assert.true(result_count > search_page.filter_results.results_count_int)
#
